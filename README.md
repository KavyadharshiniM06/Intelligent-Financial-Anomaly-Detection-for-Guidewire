...
2. Seed one demo customer and policy for valid claim submissions:
   ```bash
...
4. Open [http://localhost:3000](http://localhost:3000) and point it at your backend.

The frontend supports:
- Health checks
- Claim submission
- Claim lookup by ID
- Audit lookup by claim ID
